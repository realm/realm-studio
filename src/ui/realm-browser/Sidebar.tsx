    ...
    <ul className="RealmBrowser__Sidebar__SchemaList">
      {schemas.map((schema) => {
        const schemaClass = classnames({
          ...
          "RealmBrowser__Sidebar__Schema__Info--selected": selectedSchemaName === schema.name,
        });
        const listClass = classnames({
          "RealmBrowser__Sidebar__Sublevel": true,
          "RealmBrowser__Sidebar__Sublevel--selected": selectedSchemaName === "list",
        });
        return (
          <li
            key={schema.name}
            ...
            title={schema.name}
          >
            <div className={schemaClass} onClick={() => onSchemaSelected(schema.name)}>
            ...
            {list && list.parent.objectSchema().name === schema.name &&
            <div
              className={listClass}
            >
              ...
              <div className="RealmBrowser__Sidebar__Sublevel__Parent">
                ...
                <div className="RealmBrowser__Sidebar__Sublevel__Properties">
                  Object:
                  <span
                    onClick={() => onSchemaSelected(list.parent.objectSchema().name, list.parent)}
